...
public class AppHubspot {
	...
	driver.manage().window().fullscreen();
		...
		public void GitFetchpractice()
	{
		System.out.println("Checking the difference between fetch and pull, fetch will take the data and store in ur local and not ur working copy");
	}
